...
export default class Water extends cc.Component 
{
    ...
    private generateWater() 
    {
        ...
        this.schedule(this.scheduleWater, 0.080, this.node_water_layer.childrenCount - 1);
        this.schedule(this.scheduleWater, 0.09, this.node_water_layer.childrenCount - 1);
        this.schedule(this.scheduleWater, 0.1, this.node_water_layer.childrenCount - 1);
    }
